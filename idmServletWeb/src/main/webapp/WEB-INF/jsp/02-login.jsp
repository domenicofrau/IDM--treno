				...
				<div class="col-md-6">
					...
					<div id="loginForm">
						...
						<form action="doLogin" method="post" class="form-group">
							<input type="text" name="username" placeholder="Nome utente" class="form-control mb-2" required> <input type="password" name="password" placeholder="Password" class="form-control mb-2" required>
					...
					<div id="registerForm" style="display: none;">
						...
						<form action="doRegister" method="post" class="form-group">
							<input type="text" name="username" placeholder="Nome utente" class="form-control mb-2" required> 
							<input type="password" name="password" placeholder="Password" class="form-control mb-2" required> 
							<input type="email" name="email" placeholder="Email" class="form-control mb-2" required>
							<button type="submit" class="btn btn-success btn-block">Registra</button>
						</form>
						<button onclick="showLoginForm()" class="btn btn-secondary btn-block mt-2">Indietro</button>
					</div>
				</div>
			</div>
		</div>
