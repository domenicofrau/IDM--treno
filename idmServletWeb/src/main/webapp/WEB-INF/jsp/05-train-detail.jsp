			...
			<div class="col-12 col-md-6">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<p class="card-text">
							<b>MARCA:</b> ${ treno.marca }
						</p>
						<p class="card-text">
							<b>AUTORE:</b> ${ treno.utente.nome } ${ treno.utente.cognome }
						</p>
						<p class="card-text">
							<b>PREZZO TOTALE:</b> ${ sommaPrezzi } bitTrain
						</p>
						<p class="card-text">
							<b>PESO TOTALE:</b> ${ sommaPesi } tonnellate
						</p>
						<p class="card-text">
							<b>SIGLA:</b> sigla
						</p>
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<c:forEach var="locomotiva" items="${ locomotive }">
								...
								<div class="col-12 col-md-6">
									<div class="card mb-4">
										<div class="card-body">
											<p>
												<b>PESO:</b> ${ locomotiva.peso } tonnellate
											</p>
											<p>
												<b>PREZZO:</b> ${ locomotiva.prezzo } bitTrain
											</p>
											<p>
												<b>LUNGHEZZA:</b> ${ locomotiva.lunghezza } metri
											</p>
											<p>
												<b>PESO TRAINABILE:</b> ${ locomotiva.pesoTrainabile }
												tonnellate
											</p>
										</div>
									</div>
							...
							<c:if test="${ not empty passeggeri}">
								<div class="col-12">
									<p class="card-text font-weight-bold h4 my-2">VAGONI
										PASSEGGERI:</p>
								</div>
								...
								<c:forEach var="passeggeri" items="${ passeggeri }">
									...
									<div class="col-12 col-md-6">
										<div class="card mb-4">
											<div class="card-body">
												<p>
													<b>PESO:</b> ${ passeggeri.peso } tonnellate
												</p>
												<p>
													<b>PREZZO:</b> ${ passeggeri.prezzo } bitTrain
												</p>
												<p>
													<b>LUNGHEZZA:</b> ${ passeggeri.lunghezza } metri
												</p>
												<p>
													<b>POSTI A SEDERE:</b> ${ passeggeri.postiNormali }
												</p>
												<p>
													<b>POSTI PER DISABILI:</b> ${ passeggeri.postiDisabili }
												</p>
												<p>
													<b>POSTI TOTALI A SEDERE:</b> ${ passeggeri.postiNormali + passeggeri.postiDisabili }
												</p>
												<p>
													<b>PRESENZA SERVIZI:</b> ${ passeggeri.servizi }
												</p>
											</div>
										</div>
									</div>
								...
								<c:forEach var="passeggeriB" items="${ passeggeriB }">
									...
									<div class="col-12 col-md-6">
										<div class="card mb-4">
											<div class="card-body">
												<p>
													<b>PESO:</b> ${ passeggeriB.peso } tonnellate
												</p>
												<p>
													<b>PREZZO:</b> ${ passeggeriB.prezzo } bitTrain
												</p>
												<p>
													<b>LUNGHEZZA:</b> ${ passeggeriB.lunghezza } metri
												</p>
												<p>
													<b>POSTI A SEDERE:</b> ${ passeggeriB.postiNormali }
												</p>
												<p>
													<b>POSTI PER DISABILI:</b> ${ passeggeriB.postiDisabili }
												</p>
												<p>
													<b>POSTI TOTALI A SEDERE:</b> ${ passeggeriB.postiNormali + passeggeriB.postiDisabili }
												</p>
												<p>
													<b>PRESENZA SERVIZI:</b> ${ passeggeriB.servizi }
												</p>
											</div>
										</div>
									</div>
								...
								<c:forEach var="ristorante" items="${ ristoranti }">
									...
									<div class="col-12 col-md-6">
										<div class="card mb-4">
											<div class="card-body">
												<p>
													<b>PESO:</b> ${ ristorante.peso } tonnellate
												</p>
												<p>
													<b>PREZZO:</b> ${ ristorante.prezzo } bitTrain
												</p>
												<p>
													<b>LUNGHEZZA:</b> ${ ristorante.lunghezza } metri
												</p>
												<p>
													<b>NUMERO TAVOLI:</b> ${ ristorante.tavoli }
												</p>
												<p>
													<b>POSTI TOTALI A SEDERE:</b> ${ ristorante.tavoli * 4 }
												</p>
												<p>
													<b>PRESENZA SERVIZI:</b> ${ ristorante.servizi }
												</p>
											</div>
										</div>
									</div>
								...
								<c:forEach var="cargo" items="${ cargo }">
									...
									<div class="col-12 col-md-6">
										<div class="card mb-4">
											<div class="card-body">
												<p>
													<b>PESO:</b> ${ cargo.peso } tonnellate
												</p>
												<p>
													<b>PREZZO:</b> ${ cargo.prezzo } bitTrain
												</p>
												<p>
													<b>LUNGHEZZA:</b> ${ cargo.lunghezza } metri
												</p>
												<p>
													<b>TIPO DI MERCE TRASPORTATA:</b> ${ cargo.tipoMerce }
												</p>
											</div>
										</div>
									</div>
