		...
		<div id="frForm" style="display: none">
			<form method="POST" action="crea-treno-fr">
				<div class="form-group">
					...
					<ul class="text">
						<li><strong>H</strong> - Locomotiva (obbligatorio come primo
							vagone)</li>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="siglaFR">Sigla:</label> <input type="text"
								...
								placeholder="esempio: HPPPRP" required
								pattern="[HPBRC]+|[hpbrc]+"
								title="Sono ammessi solo i caratteri H, P, B, R, C." />
							<div class="invalid-feedback">La sigla deve iniziare con la
								lettera H.</div>
						</div>
						<div class="form-group col-md-6">
							<label for="regione_fr">Regione:</label> <select
								class="form-control" id="regione_fr" name="regione" required></select>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="form-group">
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="imageForm_fr"
								id="checkDefaultForm_fr" value="defaultForm_fr"
								onchange="showImageForm()" checked /> <label
								class="form-check-label" for="defaultForm_fr">Scegli tra
								le immagini di default</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="imageForm_fr"
								id="checkCustomForm_fr" value="customForm_fr"
								onchange="showImageForm()" /> <label class="form-check-label"
								for="customForm_fr">Carica un'immagine</label>
						</div>
					</div>
			...
			<form method="POST" action="crea-treno-tn">
				<div class="form-group">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							<label for="regione_tn">Regione:</label> <select
								class="form-control" id="regione_tn" name="regione" required></select>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="form-group">
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="imageForm_tn"
								...
								onchange="showImageForm()" checked /> <label
								class="form-check-label" for="defaultForm_tn">Scegli tra
								le immagini di default</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="imageForm_tn"
								...
								onchange="showImageForm()" /> <label class="form-check-label"
								for="customForm_tn">Carica un'immagine</label>
						</div>
					</div>
				...
				<button id="creaTreno_tn" type="submit" class="btn btn-primary mb-5">Crea il
					treno</button>
			</form>
		</div>
	</div>
