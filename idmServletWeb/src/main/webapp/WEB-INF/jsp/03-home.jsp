		...
		<div class="collapse navbar-collapse justify-content-center"
			...
			<ul class="navbar-nav align-items-center">
				...
				<li class="nav-item mr-3 active"><a class="nav-link"
					href="03-home">Home</a></li>
				<li class="nav-item mr-3"><a class="nav-link"
					href="06-crea-treno">Crea Treno</a></li>
				<li class="nav-item mr-3" id="searchIcon"><i
					class="ms-3 bi bi-search text-secondary"></i></li>
			</ul>
		</div>
	...
	<div class="container mt-5">
			...
			<form action="search" method="GET" class="form-inline">
				<div class="form-group">
					<label for="nome">Nome del treno: </label> <input type="text"
						class="form-control mx-3" id="nome" name="nome"
						placeholder="Nome del treno">
		...
		<div class="feed-section">
			...
			<c:if test="${ empty treni }">
				<h2 class="my-3 text-center font-weight-bold">Non ci sono treni
					da vedere al momento</h2>
						...
						<div class="card mb-4">
							<div class="card-body">
								...
								<img src="${treni.immagine}" alt="Train image"
									class="img-fluid train-image mb-3">
